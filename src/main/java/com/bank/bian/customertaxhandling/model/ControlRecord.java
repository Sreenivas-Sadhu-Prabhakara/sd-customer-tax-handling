package com.bank.bian.customertaxhandling.model;
...
/**
 * The BIAN control record for this service domain: "Customer Tax Record Procedure".
 *
 ...
 * to its asset type (Customer Tax Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Tax Record Procedure";
